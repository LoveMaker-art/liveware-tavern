...
- App registration: `/opt/data/tavern-state/apps.json`
- Maintained scripts: `/opt/data/skills/creative/tavern/scripts`
...
The first ClawChat greeting is controlled by `/opt/data/clawchat/greeting.md`.
...
Generated speech cache lives under `/opt/data/tavern-state/tts-cache`; clone
references live under `/opt/data/tavern-state/tts-references`. Cache identity
