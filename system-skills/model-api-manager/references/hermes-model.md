...
After a validated write, restart the gateway and verify its status. The current
response may still be generated by the old model; subsequent messages use the
new global model.
