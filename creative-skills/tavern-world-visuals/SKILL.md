...
description: Inspect, validate, apply, or reset a safe per-world Tavern visual theme and durable desktop/mobile backgrounds.
version: 1.23.17
...
```sh
THEME=/opt/data/skills/creative/tavern-world-visuals/scripts/world_theme.py
...
- Store imported art under `/opt/data/tavern-state/world-assets`, never runtime code.
