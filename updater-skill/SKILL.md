---
name: tavern-updater
description: Review, merge, install, and roll back verified Tavern Liveware releases from LoveMaker-art/liveware-tavern. Use when the user asks to check, compare, analyze differences, merge local changes, install, hot-update, audit, or roll back Tavern frontend, backend, or skill code on a Hermes/ClawChat instance.
---
...
2. Run `review`. Summarize frontend, backend, Tavern skill, and updater changes; name locally modified and automatically merged files; list every conflict.
...
- Update runtime, Tavern skill, and this updater from the same reviewed release; update the updater last.
