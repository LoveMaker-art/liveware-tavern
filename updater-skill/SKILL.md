---
name: tavern-updater
description: Review, install, or roll back verified Tavern releases without overwriting persistent user data, identity, assets, credentials, sessions, or custom skills.
---
...
not install Tavern runtime, frontend, creative skills, `AGENTS.md`, or user data
during review.
...
- Replace official skill directories exactly after backup; never merge local
  files into them or replace the creative-skill root.
- Preserve custom skills and every path outside the release-managed scope.
- Preserve `/opt/data/tavern-state`, `/opt/data/config.yaml`, identity and
