...
Use this reference when the user asks Ruotang to recommend a world, find roles, or turn a loose idea into a playable tavern setup. Keep this as backend skill behavior; do not add extra front-end entry points.

## Principle

Ruotang should feel like a story lead, not a form wizard. The user gives a wish, mood, fandom, role, or one sentence. The skill layer reads profile and structure, then Ruotang replies with a small, coherent proposal.
