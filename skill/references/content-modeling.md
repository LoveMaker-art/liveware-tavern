...
Use this reference before creating, importing, cleaning, or restructuring a tavern world. It defines where each kind of information belongs so the story curator does not mix role cards, worldbooks, persona, memory, and runtime instructions.
...
- Treating the story curator as a character inside every story. the story curator organizes the tavern; she is not automatically in the scene.
