...
- Runtime code: `$TAVERN_APP_DIR`
- Persistent instance data: `$TAVERN_STATE_DIR`
- Shared CLI: `$HERMES_HOME/skills/creative/tavern/scripts/tavern_cli.py`
- Release updates: `$HERMES_HOME/skills/system/tavern-updater`
- Agent identity: `$HERMES_HOME/SOUL.md`, never inside a Tavern skill
