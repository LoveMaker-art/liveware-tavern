...
_SOURCE_CATALOG = os.path.join(os.path.dirname(_HERE), "assets", "qwen_audio_voices.json")
VOICE_CATALOG_PATH = (
    _SOURCE_CATALOG
    if os.path.isfile(_SOURCE_CATALOG)
    else os.path.join(_HERE, "qwen_audio_voices.json")
)
